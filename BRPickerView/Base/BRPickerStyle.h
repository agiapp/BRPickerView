...
/** 设置cancelBtn标题的对齐方式 */
@property (nonatomic, assign) UIControlContentHorizontalAlignment cancelContentAlignment;
...
/** 设置 doneBtn 标题的高亮颜色 */
@property (nullable, nonatomic, strong) UIColor *doneTextHighlightColor;

/** 设置 doneBtn 标题的字体 */
@property (nullable, nonatomic, strong) UIFont *doneTextFont;

/** 设置doneBtn标题的对齐方式 */
@property (nonatomic, assign) UIControlContentHorizontalAlignment doneContentAlignment;
...
/** 设置 picker 中间选中行两端的间距 仅当设置了selectRowColor 才有效*/
@property (nonatomic, assign) CGFloat selectRowSideOffset;

/** 设置 picker 中间选中行 四个角的圆弧角度  仅当selectRowSideOffset > 0时 才有效 */
