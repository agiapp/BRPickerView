#
#  Be sure to run `pod spec lint BRPickerView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "任波"
  # s.authors            = { "任波" => "borenfocus@gmail.com" }
  # s.social_media_url   = "http://twitter.com/任波"
  ...
  # GitHib下载地址和版本
  s.source       = { :git => "https://github.com/borenfocus/BRPickerView.git", :tag => "1.0.0" }
